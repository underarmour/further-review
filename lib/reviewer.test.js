...
test('Reviewer.getReviews - disabled provider', t => {
  ...
  return r.initProviders()
    .tap(initializedProviders => {
      t.deepEqual(initializedProviders, []);
    });
});

test('Reviewer.getReviews - provider config', t => {
...
test('Reviewer.processReviews - subscription', t => {
  class TestProvider extends Provider {
    getReviews() {
      return [{
        id: 'abc',
...
test('Reviewer.processReviews - self sign - 2 required - success', t => {
  class TestProvider extends Provider {
    getReviews() {
      return [{
        id: 'abc',
...
test('Reviewer.processReviews - self sign - 2 required - failure', t => {
  class TestProvider extends Provider {
    getReviews() {
      return [{
        id: 'abc',
...
test('Reviewer.processReviews - self sign - 1 required', t => {
  class TestProvider extends Provider {
    getReviews() {
      return [{
        id: 'abc',
