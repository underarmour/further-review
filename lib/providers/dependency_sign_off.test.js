...
const HeadShaVersionOnly = 'version';
...
test('packageJsonDiff - version unchanged', t => {
  const result = packageJsonDiff({
    version: '1.0.0',
  }, {
    version: '1.0.0',
...
test('packageJsonDiff - version changed', t => {
  const result = packageJsonDiff({
    version: '1.0.0',
  }, {
    version: '1.0.0',
...
test('DependencySignOffProvider.review - modified package.json version only', async t => {
  t.context.pr.sha = HeadShaVersionOnly;
